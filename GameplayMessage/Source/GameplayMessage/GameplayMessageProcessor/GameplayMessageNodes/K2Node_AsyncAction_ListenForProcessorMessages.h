...
#include "K2Node_AsyncAction_ListenForProcessorMessages.generated.h"
 ...
 */
UCLASS()
class GAMEPLAYMESSAGENODES_API UK2Node_AsyncAction_ListenForProcessorMessages : public UK2Node_AsyncAction
{
	GENERATED_BODY()
